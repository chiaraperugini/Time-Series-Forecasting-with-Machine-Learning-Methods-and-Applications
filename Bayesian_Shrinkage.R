# ---- SET DIRECTORY
getwd()
path <- "/Users/chiaraperugini/Desktop/machine learning/Machine-Learning-Project"
setwd(path)
...
getwd()
setwd("/Users/chiaraperugini/Desktop/machine learning/Machine-Learning-Project")
